...
def draw_cat_plot():
    ...
    # Convert 'value' column to string type to avoid AttributeError
    df_cat['value'] = df_cat['value'].astype(str)

    # 7
    g = sns.catplot(data=df_cat, kind="bar",
                    x="variable", y="total", hue="value", col="cardio", height=6, aspect=1)
